...
export const arraySize = document.querySelector('#arraySize');
export const stepsQuantity = document.querySelector('#stepsQuantity');
export const delay = document.querySelector('#delay');
